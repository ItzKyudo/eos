...
export const ATTACK_RULES: Record<string, AttackRule> = {
  ...
  // Archer (Range 3 -> 1..3)
  piece3: { range: [1, 2, 3], mandatoryMove: 1 },
  piece4: { range: [1, 2, 3], mandatoryMove: 1 },
  piece15: { range: [1, 2, 3], mandatoryMove: 1 },
  piece16: { range: [1, 2, 3], mandatoryMove: 1 },
  // Deacon (Range 2 -> 1..2)
  piece5: { range: [1, 2], mandatoryMove: 1 },
  piece6: { range: [1, 2], mandatoryMove: 1 },
  ...
  piece13: { range: [1], mandatoryMove: [1, 2] },
  piece14: { range: [1], mandatoryMove: [1, 2] },
