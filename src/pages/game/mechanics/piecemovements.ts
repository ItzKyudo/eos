...
const PIECE_RULES: Record<string, number[]> = {
  ...
  // Archer: [1] (Assuming movement is 1, Attack is 3 based on attackpieces.ts)
  ...
  // Vice Roy: [1, 2]
  piece7: [1, 2], piece8: [1, 2],

  // Chancellor: [1, 2]
  piece9: [1, 2], piece10: [1, 2],

  // Minister: [1, 2]
  piece13: [1, 2], piece14: [1, 2], piece19: [1, 2], piece20: [1, 2],
