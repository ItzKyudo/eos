      ...
      <div className="relative w-full max-w-4xl bg-[#21201d] rounded-3xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] border border-white/5 flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="flex-1 p-12 lg:p-16">
          <form className="space-y-6">
            ...
            <button className="w-full bg-linear-to-r from-[#2c4dbd] to-[#e63e3e] text-white py-4 rounded-xl font-black flex items-center justify-center gap-3 group hover:brightness-110 transition-all shadow-lg active:scale-[0.98]">
              SIGN IN
